...
async function main() {
  ...
  // Creer quelques entreprises de test
  const companies = [
    {
    ...
    {
      companyName: "CHU Felix Guyon",
      address: "Allee des Topazes",
      city: "Saint-Denis",
      phone: "0262 90 55 55",
    ...
    {
      companyName: "Hotel Lux Saint-Gilles",
  ...
  // Creer quelques beneficiaires de test
  const beneficiaries = [
  ...
  console.log("  Referent: referent@mediation-active.re / referent123");
}
