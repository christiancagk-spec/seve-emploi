...
// GET /api/entreprises â Liste des entreprises
export async function GET(request: NextRequest) {
  ...
  // Les rÃ©fÃ©rents ne voient que leurs entreprises, les admins voient tout
...
// POST /api/entreprises â CrÃ©er une entreprise
