...
// GET /api/rappels â Liste des rappels (en attente, du user connectÃ©)
...
// POST /api/rappels â CrÃ©er un rappel
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: "Erreur lors de la crÃ©ation du rappel" },
      { status: 500 }
    );
  }
}

// PATCH /api/rappels â Mettre Ã  jour le statut d'un rappel
